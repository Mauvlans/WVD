...
$WVDGoldeImagePrep = New-Object system.Windows.Forms.Form
$WVDGoldeImagePrep.ClientSize = '700,800'
$WVDGoldeImagePrep.text = "Form"
$WVDGoldeImagePrep.TopMost = $false
...
$InstallFSLgox = New-Object system.Windows.Forms.CheckBox
$InstallFSLgox.text = "Install FSLogix Agent"
$InstallFSLgox.AutoSize = $false
$InstallFSLgox.width = 250
$InstallFSLgox.height = 30
$InstallFSLgox.location = New-Object System.Drawing.Point(48, 250)
$InstallFSLgox.Font = 'Microsoft Sans Serif,14'

$InstallFSLgox.Add_CheckStateChanged({
    $VHDPath.Enabled = $InstallFSLgox.Checked
})
...
$WVDGoldeImagePrep.controls.AddRange(@($Execute, $ScriptTitle, $CalendarSyncMode, $EmailCacheMonths, $CalSyncTime, $VHDPath, $AADTenantID, $InstallOffice365, $InstallFSLgox, $InstallOneDrive, $DisableWU, $InstallTeams, $InstallEdge, $RunCleanMgr, $LabelVHDLocation, $LabelAADTenant, $labelEmailCache, $labelCalSyncType, $labelCalSyncTime))

$Execute.DialogResult = [System.Windows.Forms.DialogResult]::OK
$WVDGoldeImagePrep.AcceptButton = $Execute
$Execute = $WVDGoldeImagePrep.ShowDialog()

if ($Execute -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    $FSLogixInstall = $InstallFSLgox.Checked
